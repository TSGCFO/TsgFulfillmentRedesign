// source --> https://kendrew.ca/wp-includes/js/jquery/jquery.js?ver=1.12.4
...
jQuery.noConflict();
// source --> https://kendrew.ca/wp-includes/js/jquery/jquery-migrate.min.js?ver=1.4.1
...
// source --> https://kendrew.ca/wp-content/themes/logipro/scripts/datetimepicker/datetimepicker.js?ver=4.9.9
/**
...
(function(a) {
    ...
    if (!Array.prototype.indexOf) {
        Array.prototype.indexOf = function(e, f) {
            var d, c;
            for (d = (f || 0), c = this.length; d < c; d += 1) {
                if (this[d] === e) {
                    return d
                }
            }
        ...
        return this.each(function() {
            var h = a(this),
                i = function(o) {
                    ...
                    if (o.type === "touchstart" || o.type === "touchmove" || o.type === "touchend" || o.type === "touchcancel") {
                        p = o.originalEvent.touches[0] || o.originalEvent.changedTouches[0];
                        n.x = p.pageX;
                        n.y = p.pageY
                    } else {
            ...
            if (!a(this).hasClass("xdsoft_scroller_box")) {
                ...
                f.on("mousedown.xdsoft_scroller", function(q) {
                    ...
                    var p = q.pageY,
                        r = parseInt(f.css("margin-top"), 10),
                        o = m[0].offsetHeight;
                    if (document) {
                ...
                h.on("scroll_element.xdsoft_scroller", function(o, n) {
                    ...
                    setTimeout(function() {
                        k.css("marginTop", -parseInt((k[0].offsetHeight - g) * n, 10))
                    }, 10)
                    ...
                    if (q > 1) {
                        ...
                        f.show();
                        f.css("height", parseInt(p > 10 ? p : 10, 10));
                        j = m[0].offsetHeight - f[0].offsetHeight;
                        if (n !== true) {
                            h.trigger("scroll_element.xdsoft_scroller", [o || Math.abs(parseInt(k.css("marginTop"), 10)) / (l - g)])
                        }
                    }
                });
                if (h.mousewheel) {
                    h.mousewheel(function(p, r, o, n) {
                        var q = Math.abs(parseInt(k.css("marginTop"), 10));
                ...
                h.on("touchmove", function(n) {
                    if (d) {
                        var p = i(n),
                            o = Math.abs(parseInt(k.css("marginTop"), 10));
    ...
    a.fn.datetimepicker = function(e) {
        var u = 48,
            ...
            k = 89,
            y = false,
            g = (a.isPlainObject(e) || !e) ? a.extend(true, {}, b, e) : a.extend(true, {}, b),
            n = 0,
            f, t, s, j = function(F) {
                F.on("open.xdsoft focusin.xdsoft mousedown.xdsoft", function E(G) {
                    if (F.is(":disabled") || F.is(":hidden") || !F.is(":visible") || F.data("xdsoft_datetimepicker")) {
                        return
                    }
                    clearTimeout(n);
                    n = setTimeout(function() {
                        if (!F.data("xdsoft_datetimepicker")) {
                            f(F)
                        }
        ...
        f = function(O) {
            var P = a("<div " + (g.id ? 'id="' + g.id + '"' : "") + " " + (g.style ? 'style="' + g.style + '"' : "") + ' class="xdsoft_datetimepicker xdsoft_' + g.theme + " xdsoft_noselect " + (g.weeks ? " xdsoft_showweeks" : "") + g.className + '"></div>'),
                S = a('<div class="xdsoft_copyright"><a target="_blank" href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'),
                M = a('<div class="xdsoft_datepicker active"></div>'),
                T = a('<div class="xdsoft_mounthpicker"><button type="button" class="xdsoft_prev"></button><button type="button" class="xdsoft_today_button"></button><div class="xdsoft_label xdsoft_month"><span></span><i></i></div><div class="xdsoft_label xdsoft_year"><span></span><i></i></div><button type="button" class="xdsoft_next"></button></div>'),
                Q = a('<div class="xdsoft_calendar"></div>'),
                V = a('<div class="xdsoft_timepicker active"><button type="button" class="xdsoft_prev"></button><div class="xdsoft_time_box"></div><button type="button" class="xdsoft_next"></button></div>'),
                I = V.find(".xdsoft_time_box").eq(0),
                H = a('<div class="xdsoft_time_variant"></div>'),
                E = a('<div class="xdsoft_scrollbar"></div>'),
                X = a('<div class="xdsoft_scroller"></div>'),
                G = a('<div class="xdsoft_select xdsoft_monthselect"><div></div></div>'),
                U = a('<div class="xdsoft_select xdsoft_yearselect"><div></div></div>'),
                R = false,
                Y, W, J, F, aa, K, N = 0,
                Z = 0;
            T.find(".xdsoft_month span").after(G);
            T.find(".xdsoft_year span").after(U);
            T.find(".xdsoft_month,.xdsoft_year").on("mousedown.xdsoft", function(ae) {
                var ab = a(this).find(".xdsoft_select").eq(0),
                    ah = 0,
                    af = 0,
                    ag = ab.is(":visible"),
                    ac, ad;
                ...
                if (s.currentTime) {
                    ah = s.currentTime[a(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()
                }
                ab[ag ? "hide" : "show"]();
                for (ac = ab.find("div.xdsoft_option"), ad = 0; ad < ac.length; ad += 1) {
                    if (ac.eq(ad).data("value") === ah) {
                        break
                    } else {
                        af += ac[0].offsetHeight
                    }
                }
                ab.xdsoftScroller(af / (ab.children()[0].offsetHeight - (ab[0].clientHeight)));
                ae.stopPropagation();
                return false
            });
            T.find(".xdsoft_select").xdsoftScroller().on("mousedown.xdsoft", function(ab) {
                ab.stopPropagation();
                ab.preventDefault()
            }).on("mousedown.xdsoft", ".xdsoft_option", function(ac) {
                var ab = s.currentTime.getFullYear();
                if (s && s.currentTime) {
                    s.currentTime[a(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](a(this).data("value"))
                }
                a(this).parent().parent().hide();
                P.trigger("xchange.xdsoft");
                if (g.onChangeMonth && a.isFunction(g.onChangeMonth)) {
                    g.onChangeMonth.call(P, s.currentTime, P.data("input"))
                }
                if (ab !== s.currentTime.getFullYear() && a.isFunction(g.onChangeYear)) {
                    g.onChangeYear.call(P, s.currentTime, P.data("input"))
                }
            });
            P.setOptions = function(ab) {
                g = a.extend(true, {}, g, ab);
                if (ab.allowTimes && a.isArray(ab.allowTimes) && ab.allowTimes.length) {
                    g.allowTimes = a.extend(true, [], ab.allowTimes)
                }
                if (ab.weekends && a.isArray(ab.weekends) && ab.weekends.length) {
                    g.weekends = a.extend(true, [], ab.weekends)
                }
                ...
                if (isNaN(g.dayOfWeekStart)) {
                    g.dayOfWeekStart = 0
                } else {
                    g.dayOfWeekStart = parseInt(g.dayOfWeekStart, 10) % 7
                }
                if (!g.timepickerScrollbar) {
                    E.hide()
                }
                if (g.minDate && /^-(.*)$/.test(g.minDate)) {
                    g.minDate = s.strToDateTime(g.minDate).dateFormat(g.formatDate)
                }
                if (g.maxDate && /^\+(.*)$/.test(g.maxDate)) {
                    g.maxDate = s.strToDateTime(g.maxDate).dateFormat(g.formatDate)
                }
                T.find(".xdsoft_today_button").css("visibility", !g.todayButton ? "hidden" : "visible");
                if (g.mask) {
                    var ad, ae = function(ah) {
                            try {
                                if (document.selection && document.selection.createRange) {
                                    var ag = document.selection.createRange();
                                    return ag.getBookmark().charCodeAt(2) - 2
                                }
                                if (ah.setSelectionRange) {
                                    return ah.selectionStart
                                }
                            } catch (ai) {
                                return 0
                            }
                        ...
                        ac = function(ah, ai) {
                            ah = (typeof ah === "string" || ah instanceof String) ? document.getElementById(ah) : ah;
                            if (!ah) {
                                return false
                            }
                            if (ah.createTextRange) {
                                var ag = ah.createTextRange();
                                ag.collapse(true);
                                ag.moveEnd("character", ai);
                                ag.moveStart("character", ai);
                                ag.select();
                                return true
                            }
                            if (ah.setSelectionRange) {
                                ah.setSelectionRange(ai, ai);
                                return true
                            }
                            return false
                        },
                        af = function(ag, ai) {
                            var ah = ag.replace(/([\[\]\/\{\}\(\)\-\.\+]{1})/g, "\\$1").replace(/_/g, "{digit+}").replace(/([0-9]{1})/g, "{digit$1}").replace(/\{digit([0-9]{1})\}/g, "[0-$1_]{1}").replace(/\{digit[\+]\}/g, "[0-9_]{1}");
                            return (new RegExp(ah)).test(ai)
                        };
                    O.off("keydown.xdsoft");
                    if (g.mask === true) {
                    ...
                    if (a.type(g.mask) === "string") {
                        if (!af(g.mask, O.val())) {
                            O.val(g.mask.replace(/[0-9]/g, "_"))
                        }
                        O.on("keydown.xdsoft", function(ah) {
                            var ai = this.value,
                                ag = ah.which,
                                ak, aj;
                            if (((ag >= u && ag <= o) || (ag >= i && ag <= c)) || (ag === z || ag === q)) {
                                ak = ae(this);
                                aj = (ag !== z && ag !== q) ? String.fromCharCode((i <= ag && ag <= c) ? ag - u : ag) : "_";
                                if ((ag === z || ag === q) && ak) {
                                    ak -= 1;
                                    aj = "_"
                                }
                                while (/[^0-9_]/.test(g.mask.substr(ak, 1)) && ak < g.mask.length && ak > 0) {
                                    ak += (ag === z || ag === q) ? -1 : 1
                                }
                                ai = ai.substr(0, ak) + aj + ai.substr(ak + 1);
                                if (a.trim(ai) === "") {
                                    ai = g.mask.replace(/[0-9]/g, "_")
                                } else {
                                    if (ak === g.mask.length) {
                                        ah.preventDefault();
                                        return false
                                ...
                                if (([x, d, A, p, k].indexOf(ag) !== -1 && y) || [D, r, C, v, B, w, l, h, m].indexOf(ag) !== -1) {
                                    return true
                                }
                            }
                            ah.preventDefault();
                ...
                if (g.validateOnBlur) {
                    O.off("blur.xdsoft").on("blur.xdsoft", function() {
                        if (g.allowBlank && !a.trim(a(this).val()).length) {
                            a(this).val(null);
                            P.data("xdsoft_datetime").empty()
                        } else {
                            if (!Date.parseDate(a(this).val(), g.format)) {
                                a(this).val((s.now()).dateFormat(g.format));
                                P.data("xdsoft_datetime").setCurrentTime(a(this).val())
                            } else {
                                P.data("xdsoft_datetime").setCurrentTime(a(this).val())
                            }
                        }
            ...
            P.data("options", g).on("mousedown.xdsoft", function(ab) {
                ab.stopPropagation();
                ab.preventDefault();
                U.hide();
                G.hide();
            ...
            Y = function() {
                ...
                ab.now = function(ae) {
                    var af = new Date(),
                        ac, ad;
                    if (!ae && g.defaultDate) {
                        ac = ab.strToDate(g.defaultDate);
                        af.setFullYear(ac.getFullYear());
                        af.setMonth(ac.getMonth());
                        af.setDate(ac.getDate())
                    }
                    if (g.yearOffset) {
                        af.setFullYear(af.getFullYear() + g.yearOffset)
                    }
                    if (!ae && g.defaultTime) {
                        ad = ab.strtotime(g.defaultTime);
                        af.setHours(ad.getHours());
                        af.setMinutes(ad.getMinutes())
                    }
                    return af
                };
                ab.isValidDate = function(ac) {
                    if (Object.prototype.toString.call(ac) !== "[object Date]") {
                        return false
                    }
                    return !isNaN(ac.getTime())
                };
                ab.setCurrentTime = function(ac) {
                    ab.currentTime = (typeof ac === "string") ? ab.strToDateTime(ac) : ab.isValidDate(ac) ? ac : ab.now();
                    P.trigger("xchange.xdsoft")
                };
                ab.empty = function() {
                    ab.currentTime = null
                };
                ab.getCurrentTime = function(ac) {
                    return ab.currentTime
                };
                ab.nextMonth = function() {
                    var ad = ab.currentTime.getMonth() + 1,
                        ac;
                    if (ad === 12) {
                        ab.currentTime.setFullYear(ab.currentTime.getFullYear() + 1);
                        ad = 0
                    }
                    ac = ab.currentTime.getFullYear();
                    ab.currentTime.setDate(Math.min(new Date(ab.currentTime.getFullYear(), ad + 1, 0).getDate(), ab.currentTime.getDate()));
                    ab.currentTime.setMonth(ad);
                    if (g.onChangeMonth && a.isFunction(g.onChangeMonth)) {
                        g.onChangeMonth.call(P, s.currentTime, P.data("input"))
                    }
                    if (ac !== ab.currentTime.getFullYear() && a.isFunction(g.onChangeYear)) {
                        g.onChangeYear.call(P, s.currentTime, P.data("input"))
                    }
                    P.trigger("xchange.xdsoft");
                    return ad
                };
                ab.prevMonth = function() {
                    var ac = ab.currentTime.getMonth() - 1;
                    if (ac === -1) {
                        ab.currentTime.setFullYear(ab.currentTime.getFullYear() - 1);
                        ac = 11
                    }
                    ab.currentTime.setDate(Math.min(new Date(ab.currentTime.getFullYear(), ac + 1, 0).getDate(), ab.currentTime.getDate()));
                    ab.currentTime.setMonth(ac);
                    if (g.onChangeMonth && a.isFunction(g.onChangeMonth)) {
                        g.onChangeMonth.call(P, s.currentTime, P.data("input"))
                    }
                    P.trigger("xchange.xdsoft");
                ...
                ab.getWeekOfYear = function(ad) {
                    var ac = new Date(ad.getFullYear(), 0, 1);
                    return Math.ceil((((ad - ac) / 86400000) + ac.getDay() + 1) / 7)
                };
                ab.strToDateTime = function(af) {
                    var ad = [],
                        ac, ae;
                    if (af && af instanceof Date && ab.isValidDate(af)) {
                        return af
                    }
                    ad = /^(\+|\-)(.*)$/.exec(af);
                    if (ad) {
                        ad[2] = Date.parseDate(ad[2], g.formatDate)
                    }
                    if (ad && ad[2]) {
                        ac = ad[2].getTime() - (ad[2].getTimezoneOffset()) * 60000;
                        ae = new Date((s.now()).getTime() + parseInt(ad[1] + "1", 10) * ac)
                    } else {
                        ae = af ? Date.parseDate(af, g.format) : ab.now()
                    }
                    if (!ab.isValidDate(ae)) {
                        ae = ab.now()
                    }
                    return ae
                };
                ab.strToDate = function(ad) {
                    if (ad && ad instanceof Date && ab.isValidDate(ad)) {
                        return ad
                    }
                    var ac = ad ? Date.parseDate(ad, g.formatDate) : ab.now(true);
                    if (!ab.isValidDate(ac)) {
                        ac = ab.now(true)
                    }
                    return ac
                };
                ab.strtotime = function(ac) {
                    if (ac && ac instanceof Date && ab.isValidDate(ac)) {
                        return ac
                    }
                    var ad = ac ? Date.parseDate(ac, g.formatTime) : ab.now(true);
                    if (!ab.isValidDate(ad)) {
                        ad = ab.now(true)
                    }
                    return ad
                };
                ab.str = function() {
                    return ab.currentTime.dateFormat(g.format)
                };
                ab.currentTime = this.now()
            };
            s = new Y();
            T.find(".xdsoft_today_button").on("mousedown.xdsoft", function() {
                P.data("changed", true);
                s.setCurrentTime(0);
                P.trigger("afterOpen.xdsoft")
            ...
            T.find(".xdsoft_prev,.xdsoft_next").on("mousedown.xdsoft", function() {
                var ac = a(this),
                    ...
                    ab = false;
                (function ae(ag) {
                    var ah = s.currentTime.getMonth();
                    if (ac.hasClass(g.next)) {
                        s.nextMonth()
                    } else {
                        if (ac.hasClass(g.prev)) {
                            s.prevMonth()
                        }
                    }
                    if (g.monthChangeSpinner) {
                        if (!ab) {
                            af = setTimeout(ae, ag || 100)
                        }
                    }
                }(500));
                a([document.body, window]).on("mouseup.xdsoft", function ad() {
                    clearTimeout(af);
                    ab = true;
                    a([document.body, window]).off("mouseup.xdsoft", ad)
                })
            });
            V.find(".xdsoft_prev,.xdsoft_next").on("mousedown.xdsoft", function() {
                var ae = a(this),
                    ...
                    af = 110;
                (function ad(ai) {
                    var ak = I[0].clientHeight,
                        ah = H[0].offsetHeight,
                        aj = Math.abs(parseInt(H.css("marginTop"), 10));
                    if (ae.hasClass(g.next) && (ah - ak) - g.timeHeightInTimePicker >= aj) {
                        H.css("marginTop", "-" + (aj + g.timeHeightInTimePicker) + "px")
                    } else {
                        if (ae.hasClass(g.prev) && aj - g.timeHeightInTimePicker >= 0) {
                            H.css("marginTop", "-" + (aj - g.timeHeightInTimePicker) + "px")
                        }
                    }
                    I.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(H.css("marginTop"), 10) / (ah - ak))]);
                    af = (af > 10) ? 10 : af - 10;
                    if (!ab) {
                        ag = setTimeout(ad, ai || af)
                    }
                }(500));
                a([document.body, window]).on("mouseup.xdsoft", function ac() {
                    clearTimeout(ag);
                    ab = true;
                    a([document.body, window]).off("mouseup.xdsoft", ac)
                })
            });
            J = 0;
            P.on("xchange.xdsoft", function(ab) {
                clearTimeout(J);
                J = setTimeout(function() {
                    var ar = "",
                        ad = new Date(s.currentTime.getFullYear(), s.currentTime.getMonth(), 1, 12, 0, 0),
                        aj = 0,
                        ai, an = s.now(),
                        ac = false,
                        ah = false,
                        ...
                        ak = "",
                        al;
                    while (ad.getDay() !== g.dayOfWeekStart) {
                    ...
                    for (ai = 0; ai < 7; ai += 1) {
                        ar += "<th>" + g.i18n[g.lang].dayOfWeek[(ai + g.dayOfWeekStart) % 7] + "</th>"
                    }
                    ar += "</tr></thead>";
                    ar += "<tbody>";
                    if (g.maxDate !== false) {
                        ac = s.strToDate(g.maxDate);
                        ac = new Date(ac.getFullYear(), ac.getMonth(), ac.getDate(), 23, 59, 59, 999)
                    }
                    if (g.minDate !== false) {
                        ah = s.strToDate(g.minDate);
                        ah = new Date(ah.getFullYear(), ah.getMonth(), ah.getDate())
                    }
                    while (aj < s.currentTime.countDaysInMonth() || ad.getDay() !== g.dayOfWeekStart || s.currentTime.getMonth() === ad.getMonth()) {
                        ag = [];
                        aj += 1;
                        am = ad.getDate();
                        ao = ad.getFullYear();
                        af = ad.getMonth();
                        ap = s.getWeekOfYear(ad);
                        ag.push("xdsoft_date");
                        if (g.beforeShowDay && a.isFunction(g.beforeShowDay.call)) {
                            at = g.beforeShowDay.call(P, ad)
                        } else {
                            at = null
                        }
                        if ((ac !== false && ad > ac) || (ah !== false && ad < ah) || (at && at[0] === false)) {
                            ag.push("xdsoft_disabled")
                        }
                        if (at && at[1] !== "") {
                            ag.push(at[1])
                        }
                        if (s.currentTime.getMonth() !== af) {
                            ag.push("xdsoft_other_month")
                        }
                        if ((g.defaultSelect || P.data("changed")) && s.currentTime.dateFormat(g.formatDate) === ad.dateFormat(g.formatDate)) {
                            ag.push("xdsoft_current")
                        }
                        if (an.dateFormat(g.formatDate) === ad.dateFormat(g.formatDate)) {
                            ag.push("xdsoft_today")
                        }
                        if (ad.getDay() === 0 || ad.getDay() === 6 || g.weekends.indexOf(ad.dateFormat(g.formatDate)) === -1) {
                            ag.push("xdsoft_weekend")
                        }
                        if (g.beforeShowDay && a.isFunction(g.beforeShowDay)) {
                            ag.push(g.beforeShowDay(ad))
                        }
                        if (aq) {
                            ar += "<tr>";
                            aq = false;
                        ...
                        ar += '<td data-date="' + am + '" data-month="' + af + '" data-year="' + ao + '" class="xdsoft_date xdsoft_day_of_week' + ad.getDay() + " " + ag.join(" ") + '"><div>' + am + "</div></td>";
                        if (ad.getDay() === g.dayOfWeekStartPrev) {
                            ar += "</tr>";
                            aq = true
                        }
                        ad.setDate(am + 1)
                    ...
                    ar += "</tbody></table>";
                    Q.html(ar);
                    T.find(".xdsoft_label span").eq(0).text(g.i18n[g.lang].months[s.currentTime.getMonth()]);
                    T.find(".xdsoft_label span").eq(1).text(s.currentTime.getFullYear());
                    ae = "";
                    ak = "";
                    af = "";
                    al = function al(aw, au) {
                        var av = s.now();
                        av.setHours(aw);
                        aw = parseInt(av.getHours(), 10);
                        av.setMinutes(au);
                        au = parseInt(av.getMinutes(), 10);
                        ag = [];
                        if ((g.maxTime !== false && s.strtotime(g.maxTime).getTime() < av.getTime()) || (g.minTime !== false && s.strtotime(g.minTime).getTime() > av.getTime())) {
                            ag.push("xdsoft_disabled")
                        }
                        if ((g.initTime || g.defaultSelect || P.data("changed")) && parseInt(s.currentTime.getHours(), 10) === parseInt(aw, 10) && (g.step > 59 || Math[g.roundTime](s.currentTime.getMinutes() / g.step) * g.step === parseInt(au, 10))) {
                            if (g.defaultSelect || P.data("changed")) {
                                ag.push("xdsoft_current")
                            } else {
                                if (g.initTime) {
                                    ag.push("xdsoft_init_time")
                                }
                            }
                        }
                        if (parseInt(an.getHours(), 10) === parseInt(aw, 10) && parseInt(an.getMinutes(), 10) === parseInt(au, 10)) {
                            ag.push("xdsoft_today")
                        }
                        ae += '<div class="xdsoft_time ' + ag.join(" ") + '" data-hour="' + aw + '" data-minute="' + au + '">' + av.dateFormat(g.formatTime) + "</div>"
                    };
                    if (!g.allowTimes || !a.isArray(g.allowTimes) || !g.allowTimes.length) {
                        for (aj = 0, ai = 0; aj < (g.hours12 ? 12 : 24); aj += 1) {
                            for (ai = 0; ai < 60; ai += g.step) {
                                ak = (aj < 10 ? "0" : "") + aj;
                                af = (ai < 10 ? "0" : "") + ai;
                                al(ak, af)
                            }
                        ...
                        for (aj = 0; aj < g.allowTimes.length; aj += 1) {
                            ak = s.strtotime(g.allowTimes[aj]).getHours();
                            af = s.strtotime(g.allowTimes[aj]).getMinutes();
                            al(ak, af)
                        }
                    }
                    H.html(ae);
                    e = "";
                    aj = 0;
                    for (aj = parseInt(g.yearStart, 10) + g.yearOffset; aj <= parseInt(g.yearEnd, 10) + g.yearOffset; aj += 1) {
                        e += '<div class="xdsoft_option ' + (s.currentTime.getFullYear() === aj ? "xdsoft_current" : "") + '" data-value="' + aj + '">' + aj + "</div>"
                    }
                    U.children().eq(0).html(e);
                    for (aj = 0, e = ""; aj <= 11; aj += 1) {
                        e += '<div class="xdsoft_option ' + (s.currentTime.getMonth() === aj ? "xdsoft_current" : "") + '" data-value="' + aj + '">' + g.i18n[g.lang].months[aj] + "</div>"
                    }
                    G.children().eq(0).html(e);
                    a(P).trigger("generate.xdsoft")
                }, 10);
                ab.stopPropagation()
            }).on("afterOpen.xdsoft", function() {
                if (g.timepicker) {
                    var ac, ae, ab, ad;
                    if (H.find(".xdsoft_current").length) {
                        ac = ".xdsoft_current"
                    } else {
                        if (H.find(".xdsoft_init_time").length) {
                            ac = ".xdsoft_init_time"
                        }
                    }
                    if (ac) {
                        ae = I[0].clientHeight;
                        ab = H[0].offsetHeight;
                        ad = H.find(ac).index() * g.timeHeightInTimePicker + 1;
                        if ((ab - ae) < ad) {
                            ad = ab - ae
                        }
                        I.trigger("scroll_element.xdsoft_scroller", [parseInt(ad, 10) / (ab - ae)])
                    } else {
            ...
            F = 0;
            Q.on("click.xdsoft", "td", function(ab) {
                ab.stopPropagation();
                F += 1;
                var ad = a(this),
                    ac = s.currentTime;
                ...
                if (ad.hasClass("xdsoft_disabled")) {
                    return false
                }
                ac.setDate(1);
                ac.setFullYear(ad.data("year"));
                ac.setMonth(ad.data("month"));
                ac.setDate(ad.data("date"));
                P.trigger("select.xdsoft", [ac]);
                O.val(s.str());
                if ((F > 1 || (g.closeOnDateSelect === true || (g.closeOnDateSelect === 0 && !g.timepicker))) && !g.inline) {
                    P.trigger("close.xdsoft")
                }
                if (g.onSelectDate && a.isFunction(g.onSelectDate)) {
                    g.onSelectDate.call(P, s.currentTime, P.data("input"), ab)
                }
                P.data("changed", true);
                P.trigger("xchange.xdsoft");
                P.trigger("changedatetime.xdsoft");
            ...
            H.on("click.xdsoft", "div", function(ab) {
                ab.stopPropagation();
                var ad = a(this),
                    ac = s.currentTime;
                if (ac === undefined || ac === null) {
                ...
                ac.setHours(ad.data("hour"));
                ac.setMinutes(ad.data("minute"));
                P.trigger("select.xdsoft", [ac]);
                P.data("input").val(s.str());
                if (!g.inline) {
                    P.trigger("close.xdsoft")
                }
                if (g.onSelectTime && a.isFunction(g.onSelectTime)) {
                    g.onSelectTime.call(P, s.currentTime, P.data("input"), ab)
                }
                P.data("changed", true);
                P.trigger("xchange.xdsoft");
                P.trigger("changedatetime.xdsoft")
            ...
            if (P.mousewheel) {
                M.mousewheel(function(ad, ae, ac, ab) {
                    if (!g.scrollMonth) {
                        return true
                    }
                    if (ae < 0) {
                ...
                I.unmousewheel().mousewheel(function(ae, ai, ad, ac) {
                    if (!g.scrollTime) {
                        return true
                    }
                    var ah = I[0].clientHeight,
                        ab = H[0].offsetHeight,
                        ag = Math.abs(parseInt(H.css("marginTop"), 10)),
                        af = true;
                    if (ai < 0 && (ab - ah) - g.timeHeightInTimePicker >= ag) {
                        H.css("marginTop", "-" + (ag + g.timeHeightInTimePicker) + "px");
                        af = false
                    } else {
                        if (ai > 0 && ag - g.timeHeightInTimePicker >= 0) {
                            H.css("marginTop", "-" + (ag - g.timeHeightInTimePicker) + "px");
                            af = false
                        }
                    }
                    I.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(H.css("marginTop"), 10) / (ab - ah))]);
                    ae.stopPropagation();
                    return af
                });
                O.mousewheel(function(ad, ae, ac, ab) {
                    if (!g.scrollInput) {
                        return true
                    }
                    if (!g.datepicker && g.timepicker) {
                        aa = H.find(".xdsoft_current").length ? H.find(".xdsoft_current").eq(0).index() : 0;
                        if (aa + ae >= 0 && aa + ae < H.children().length) {
                            aa += ae
                        }
                        if (H.children().eq(aa).length) {
                            H.children().eq(aa).trigger("mousedown")
                        }
                        return false
                    }
                    if (g.datepicker && !g.timepicker) {
                        M.trigger(ad, [ae, ac, ab]);
                        if (O.val) {
                            O.val(s.str())
                        }
                        P.trigger("changedatetime.xdsoft");
            ...
            P.on("changedatetime.xdsoft", function(ab) {
                if (g.onChangeDateTime && a.isFunction(g.onChangeDateTime)) {
                    var ac = P.data("input");
                    g.onChangeDateTime.call(P, s.currentTime, ac, ab);
                    delete g.value;
                    ac.trigger("change")
                }
            }).on("generate.xdsoft", function() {
                if (g.onGenerate && a.isFunction(g.onGenerate)) {
                    g.onGenerate.call(P, s.currentTime, P.data("input"))
                }
                if (R) {
                    P.trigger("afterOpen.xdsoft");
                    R = false
                }
            }).on("click.xdsoft", function(ab) {
                ab.stopPropagation()
            });
            aa = 0;
            K = function() {
                var ae = P.data("input").offset(),
                    ad = ae.top + P.data("input")[0].offsetHeight - 1,
                    ac = ae.left,
                    ab = "absolute";
                if (g.fixed) {
                    ad -= a(window).scrollTop();
                    ac -= a(window).scrollLeft();
                    ab = "fixed"
                } else {
                    if (ad + P[0].offsetHeight > a(window).height() + a(window).scrollTop()) {
                        ad = ae.top - P[0].offsetHeight + 1
                    }
                    if (ad < 0) {
                        ad = 0
                    }
                    if (ac + P[0].offsetWidth > a(window).width()) {
                        ac = a(window).width() - P[0].offsetWidth
                    }
                }
                P.css({
                    left: ac,
            ...
            P.on("open.xdsoft", function(ac) {
                var ad = true;
                if (g.onShow && a.isFunction(g.onShow)) {
                    ad = g.onShow.call(P, s.currentTime, P.data("input"), ac)
                }
                if (ad !== false) {
                    P.show();
                    K();
                    a(window).off("resize.xdsoft", K).on("resize.xdsoft", K);
                    if (g.closeOnWithoutClick) {
                        a([document.body, window]).on("mousedown.xdsoft", function ab() {
                            P.trigger("close.xdsoft");
                            a([document.body, window]).off("mousedown.xdsoft", ab)
                        })
                    }
                }
            }).on("close.xdsoft", function(ac) {
                var ab = true;
                T.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide();
                if (g.onClose && a.isFunction(g.onClose)) {
                    ab = g.onClose.call(P, s.currentTime, P.data("input"), ac)
                }
                if (ab !== false && !g.opened && !g.inline) {
                    P.hide()
                }
                ac.stopPropagation()
            }).data("input", O);
            ...
            function L() {
                var ab = false,
                    ac;
                if (g.startDate) {
                    ab = s.strToDate(g.startDate)
                } else {
                    ab = g.value || ((O && O.val && O.val()) ? O.val() : "");
                    if (ab) {
                        ab = s.strToDateTime(ab)
                    } else {
                        if (g.defaultDate) {
                            ab = s.strToDate(g.defaultDate);
                            if (g.defaultTime) {
                                ac = s.strtotime(g.defaultTime);
                                ab.setHours(ac.getHours());
                                ab.setMinutes(ac.getMinutes())
                            }
                        }
                    }
                }
                if (ab && s.isValidDate(ab)) {
                    P.data("changed", true)
                } else {
                    ab = ""
                }
            ...
            s.setCurrentTime(L());
            O.data("xdsoft_datetimepicker", P).on("open.xdsoft focusin.xdsoft mousedown.xdsoft", function(ab) {
                if (O.is(":disabled") || O.is(":hidden") || !O.is(":visible") || (O.data("xdsoft_datetimepicker").is(":visible") && g.closeOnInputClick)) {
                    return
                }
                clearTimeout(N);
                N = setTimeout(function() {
                    if (O.is(":disabled") || O.is(":hidden") || !O.is(":visible")) {
                        return
                    }
                    R = true;
                    s.setCurrentTime(L());
                    P.trigger("open.xdsoft")
                }, 100)
            }).on("keydown.xdsoft", function(ad) {
                var ae = this.value,
                    ac, ab = ad.which;
                if ([m].indexOf(ab) !== -1) {
                    ac = a("input:visible,textarea:visible");
                    P.trigger("close.xdsoft");
                    ac.eq(ac.index(this) + 1).focus();
                    return false
                }
                if ([h].indexOf(ab) !== -1) {
                    P.trigger("close.xdsoft");
        ...
        t = function(E) {
            var F = E.data("xdsoft_datetimepicker");
            if (F) {
                F.data("xdsoft_datetime", null);
                F.remove();
        ...
        a(document).off("keydown.xdsoftctrl keyup.xdsoftctrl").on("keydown.xdsoftctrl", function(E) {
            if (E.keyCode === l) {
                y = true
            }
        ...
        return this.each(function() {
            var E = a(this).data("xdsoft_datetimepicker");
            if (E) {
                if (a.type(e) === "string") {
                    switch (e) {
                        case "show":
                        ...
                        case "reset":
                            ...
                            if (!this.value || !E.data("xdsoft_datetime").isValidDate(Date.parseDate(this.value, g.format))) {
...
// source --> https://kendrew.ca/wp-content/plugins/freevision-tracker/script/frontend.js?ver=4.9.9
...
function ajax_tracking_search(tracking_id, g_recaptcha_code) {
    ...
    jQuery.ajax({
        ...
        data: {
            action: 'freevision_tracking_ajax_search',
            'tracking_id': encodeURIComponent(tracking_id),
            'g_recaptcha_code': g_recaptcha_code
        },
        cache: false,
...
function email_tracking_pdf(post_id) {
    ...
    jQuery.ajax({
        url: ozy_headerType.$OZY_WP_AJAX_URL,
        data: {
            action: 'freevision_tracking_ajax_pdf_email',
            'post_id': post_id
        },
        cache: false,
        success: function(data) {
...
jQuery(document).ready(function($) {
    $('.freevision-tracker-query-table').stacktable();
    ...
    $('#freevision_tracker_pdf_download').click(function(e) {
        e.preventDefault();
        download_tracking_pdf($(this).data('trackingid'));
    });

    $('#freevision_tracker_pdf_email').click(function(e) {
        e.preventDefault();
        email_tracking_pdf($(this).data('trackingid'));
    });

    $('#freevision_tracker_print').click(function(e) {
        e.preventDefault();
            ...
            var t = {
                ...
                notify: function(e, o, n) {
                    ...
                    a.className = o || "default", t.logTemplateMethod ? a.innerHTML = t.logTemplateMethod(e) : a.innerHTML = e, "function" == typeof n && a.addEventListener("click", n), i.appendChild(a), setTimeout(function() {
                        a.className += " show content-font-family"
                ...
                injectCSS: function() {
                    if (!document.querySelector("#alertifyCSS")) {
                        ...
                        e.type = "text/css", e.id = "alertifyCSS", e.innerHTML = "", t.insertBefore(e, t.firstChild)
                    }
                },
                removeCSS: function() {
...
// source --> https://kendrew.ca/wp-content/plugins/revslider/public/assets/js/jquery.themepunch.tools.min.js?ver=5.4.8
/********************************************
...
// source --> https://kendrew.ca/wp-content/plugins/revslider/public/assets/js/jquery.themepunch.revolution.min.js?ver=5.4.8
/**************************************************************************
...
// source --> https://kendrew.ca/wp-content/themes/logipro/scripts/modernizr.js?ver=4.9.9
